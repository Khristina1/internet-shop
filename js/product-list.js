class ProductList {
  constructor(productsUrl, renderContainer, cart) {
    ...
    fetch(productsUrl)
      ...
      .then(products => {
        this.products = products.sort((a, b) => b.price - a.price ); // сортуєм продукти за ціною від найбільшої до найменшої 
      ...
      productListDomString += `<div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-3">
                  <div class="card product">
                    ...
                    <div class="card-body">
                      ...
                      <h4 clas="card-origin">${product.origin}</h4>
  ...
  addEventListeners() {
    $('#productInfoModal').on('show.bs.modal', event => {
      ...
      modal.find('.modal-body .card-origin').text(product.origin);
    ...
    $('.card.product button.buy, #productInfoModal button.buy').click(event => {
      ...
      window.showAlert('Додано в корзину');
    });
  }
}
